...
\end{flalign*}
\item \begin{flalign*}
	\int (\sin{(2x+5)}+\cos{(5x+2)})dx\\
	=-\frac{1}{2}\cos{(2x+5)}+\frac{1}{5}\sin{(5x+2)}
\end{flalign*}
\end{enumerate}
...
\item \begin{flalign*}
	...
	=\int \frac{x^2}{t} \frac{dt}{3x^2} =\frac{1}{3}\int \frac{1}{t}dt	\\
	=\frac{1}{3}\log{|t|}=\frac{1}{3}\log{|x^3+2|}
\end{flalign*}
\item \begin{flalign*}
	\int \frac{1-\log{x}}{x}dx\\
	t=1-\log{x}\hspace{1cm} dt=-\frac{1}{x}dx\\
	=-\int \frac{t}{x}xdt=-\int tdt\\
	=-\frac{1}{2}t^2=-\frac{1}{2}(1-\log{x})^2
\end{flalign*}
\item \begin{flalign*}
	\int x\sqrt{x^2+1}dx \hspace{2cm}\\
	t=\sqrt{x^2+1} \hspace{1cm} dt=\frac{x}{t}dt\\
	=\int xt\frac{t}{x}dt=\int t^2dt=\frac{1}{3}t^3\\
	=\frac{1}{3}(x^2+1)\sqrt{x^2+1}
\end{flalign*}
\item \begin{flalign*}
	\int x \cos{x} dx \hspace{1cm}\\
...
\item \begin{flalign*}
	...
	&=\int \frac{\cos^3{x}(1+\sin{x}}{\cos^2{x}}dx\\
	&t=1+\sin{x} \hspace{1cm}dt=\cos{x}dx \hspace{1cm} dx=\frac{dt}{\cos{x}}\\
	&=\int \cos{x} \cdot t \cdot \frac{dt}{\cos{x}}\\
	&=\frac{1}{2}t^2\\
	&=\frac{1}{2}(1+\sin{x})^2
\end{flalign*}
\item \begin{flalign*}
	...
	&=x\arctan{x}-\int \frac{x}{t} \cdot \frac{dt}{2x}\\
	&= x\arctan{x}-\frac{1}{2}\log{|t|}\\
	&=x\arctan{x}-\frac{1}{2}\log{(1+x^2)}
\end{flalign*}
\item \begin{flalign*}
	&\int \frac{1}{2+\cos{x}}dx\\
	&t=\tan{\frac{x}{2}} \hspace{5mm} \cos{x}=\frac{1-t^2}{1+t^2} \hspace{5mm} dx=\frac{2dt}{1+t^2}\\
	&\int \frac{1}{2+\frac{1-t^2}{1+t^2}} \cdot \frac{2dt}{1+t^2}\\
	&=\int \frac{2dt}{2+2t^2t^2}\\
	&=\int \frac{2dt}{3+t^2}\\
	&=\frac{2}{\sqrt{3}}\arctan{\frac{t}{\sqrt{3}}}\\
...
\item \begin{flalign*}
	 ...
	 &=(2\sin{x}-\cos{x})e^{2x}-4I\\
	 &5I=(2\sin{x}-\cos{x})e^{2x}\\
	 &I=\frac{1}{5}(2\sin{x}-\cos{x})e^{2x}
\end{flalign*}
\item \begin{flalign*}
	&\int \frac{1}{\sqrt{e^x+2}}dx\\
	&t=\sqrt{e^x+2} \hspace{1cm} dt=\frac{e^x}{2t}dx \hspace{1cm} dx=\frac{2t}{t^2-2}dt\\
	&=\int \left( \frac{1}{t} \cdot \frac{2t}{t^2-2}\right)  dt\\
	&=\frac{1}{\sqrt{2}}\log{\left| \frac{t-\sqrt{2}}{t+\sqrt{2}} \right| }\\
	&=\frac{1}{\sqrt{2}}\log{\left| \frac{\sqrt{e^x+2} -\sqrt{2}}{\sqrt{e^x+2} +\sqrt{2}} \right| }\\
\end{flalign*}
\end{enumerate}
...
\item\begin{flalign*}
	...
	&= \frac{1}{3} \int \left( \frac{1}{x+2}+\frac{2}{x-1} \right) dx\\
	&=\frac{1}{3} (\log{|x+2|}+2\log{|x-1|})
\end{flalign*}
\item\begin{flalign*}
	&\int \frac{x^2+2x-1}{(x+1)(x^2+4x+5)}dx\\
	&=\int \left( \frac{a}{x+1}+\frac{bx+c}{x^2+4x+5} \right) dx\\
	...
	&=\int \left( \frac{-1}{x+1}+\frac{2x+4}{x^2+4x+5} \right) dx\\
	&=\log{\left| \frac{x^2+4x+5}{x+1} \right|}
\end{flalign*}
\end{enumerate}
...
\item \begin{flalign*}
	...
	=\left[\frac{x^4}{4}+x^3 \right]^2_0 \\
	=4+8=12\\
\end{flalign*}
\item \begin{flalign*}
	&\int^0_{-2} \frac{1}{x^2+4x+8}dx\\
	&=\int^0_{-2} \frac{1}{(x+2)^2+4}dx\\
	&=\frac{1}{2}\left[ \arctan{\frac{x+2}{2}} \right]^0_{-2}\\
	&=\frac{1}{2}\frac{\pi}{4}=\frac{\pi}{8}\\
\end{flalign*}
\item \begin{flalign*}
	&\int^\frac{\pi}{4}_0 \cos^2{x}dx\\
	&\frac{1}{2} \int^\frac{\pi}{4}_0  (1+\cos{2x})dx\\
	&=\frac{1}{2}\left[x-\frac{1}{2}\sin{2x}\right]^\frac{\pi}{4}_0 
	=\frac{1}{2} \left( \frac{\pi}{4}+\frac{1}{2} \right)
\end{flalign*}
\item \begin{flalign*}
	&\int^{\sqrt{3}}_{-1} \frac{1}{\sqrt{4-x^2}}dx\\
	&=\left[ \arcsin{\frac{x}{2}} \right] ^{\sqrt{3}}_{-1} \\
	&=\frac{\pi}{3}+\frac{\pi}{6}=\frac{\pi}{2}
\end{flalign*}
\item \begin{flalign*}
	&\int^{\frac{\pi}{3}}_0 \tan{x}dx\\
	&=[-\log{|\cos{x}|}]^{\frac{\pi}{3}}_0\\
	&=\log{2}
\end{flalign*}
\item \begin{flalign*}
	&\int^1_0 \frac{1}{\sqrt{x^2+1}} dx\\
	&=[\log{|x+\sqrt{x^2+1}|}]^1_0\\
	&= \log{(1+\sqrt{2})}
\end{flalign*}
\end{enumerate}
\end{document}